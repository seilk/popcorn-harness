...
1. `~/.claude/plugins/popcorn-harness/skills/popcorn-harness/SKILL.md`
2. `~/.claude/skills/popcorn-harness/SKILL.md`
...
"popcorn-harness skill not found. Install with: /plugin install https://github.com/seilk/popcorn-harness"
